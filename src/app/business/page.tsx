...
import { DollarSign, Users, CreditCard, Package, FileText, Building2, FilePieChart } from "lucide-react";
...
const businessNavItems = [
    ...
    { href: "/business/invoices", label: "Invoices", icon: FilePieChart, description: "Create and manage invoices." },
]
